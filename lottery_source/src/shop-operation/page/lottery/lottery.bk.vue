<template>
  <div id="lotteryPage" class="scroll fh re" @scroll="scroll($event)">
    <div class="header re">
...
import list from './components/lottery-list.bk'
...
export default {
  ...
  methods: {
    ...
    scroll(e) {
      let limit = e.target.scrollHeight - document.body.clientHeight;
      let scrollTop = e.target.scrollTop;
      let listHeight = document.body.clientHeight-limit + scrollTop;
      if(limit <= scrollTop) {
