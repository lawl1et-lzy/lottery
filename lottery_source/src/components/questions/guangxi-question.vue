<template>
  <div class="box fh scroll">
     <div class="form">
        ...
        <div class="info">
            <div class="q-item">
                <p>4、 先货后款， 免机器设备押金， 保底7%的毛利率，您想不想卖即开型彩票？</p>
                <label>
        ...
        <div class="info">
            <div class="q-item">
                <p>5、 返奖率高达65%，活动多，例如赠送金条活动， 还有奖上奖，您想不想卖即开型彩票？</p>
                <label>
        ...
        <div class="info">
            <div class="q-item">
                <p>6、 您想不想在销售即开型彩票的同时增加额外奖励？（如：日销售冠军、周销售冠军、月销售冠军）</p>
                <label>
...
export default {
  ...
  methods: {
    ...
    getInitData () {
      api.request('mobile/Register/getQuestion')
      .then( res => {
        if (res.code == 0) {
